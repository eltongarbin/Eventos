...
{
    [Binding]
    public class CadastroDeEventoSteps
    {
        public SeleniumHelper Browser;

        public CadastroDeEventoSteps()
        {
        ...
        {
            Assert.Equal(string.Concat(ConfigurationHelper.SiteUrl, "eventos/meus-eventos"), Browser.ObterUrl());
